...
Class code can be found in [src/main/java](src/main/java).
...
* **0.2.3:** Fixed PreparedStatements to prevent [SQL injection](https://xkcd.com/327/), and fixed bug where Service 
booking button was not displayed in the RecepView. 
